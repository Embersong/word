        ...
        <div class="container">
          ...
          <div class="row blog-entries">
            <div class="col-md-12 col-lg-8 main-content">
              <div class="row">
                  <?php foreach ($posts as ['url' => $url, 'alt' => $alt, 'photo' => $photo, 'nick' => $nick, 'date' => $date, 'count'=> $count, 'title' => $title]): ?>
                    <div class="col-md-6">
                      <a href="blog-single.html" class="blog-entry element-animate" data-animate-effect="fadeIn">
                        <img src="images/<?=$url?>" alt="<?=$alt?>">
                        <div class="blog-content-body">
                          <div class="post-meta">
                            <span class="author mr-2"><img src="images/<?=$photo?>" alt="Colorlib"> <?=$nick?></span>&bullet;
